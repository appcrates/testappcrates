...
class GroupNumber2 extends Component {
    render() {
        return (
            <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9 text-left mt-2">
                            ...
                            <p className="mt-3 pera">
                                ...
                                layout. Praesent it is a long established fact that a reader
